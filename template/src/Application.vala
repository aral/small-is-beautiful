...
namespace SmallisBeautiful {
    ...
    public class Application : Gtk.Application {
        ...
        public Application () {
            Object(
                application_id: "com.github.aral.small_is_beautiful",
                flags: ApplicationFlags.FLAGS_NONE
            );

            saved_state = new GLib.Settings ("com.github.aral.small_is_beautiful.saved-state");
            ...
            // on the --help screen.
            set_option_context_summary (_("This app shows off Watson"));
            ...
            handle_local_options.connect((application, options) => {
                ...
                if (options.contains("version")) {
                    print (@"Small is Beautiful $(Constants.Config.VERSION)\n");
